					...
					<div class="row pt-50">
						<div class="form-group">
							<div class="col-xs-4 col-sm-offset-5 col-sm-10">
								<a class="btn btn-default" href="javascript:validateAndCommit();">Register</a> <input type="button" class="btn btn-default" value="Return"
									onclick="javascript:window.location.href='toIndex'" />
							</div>
						</div>
					</div>
				</form>
