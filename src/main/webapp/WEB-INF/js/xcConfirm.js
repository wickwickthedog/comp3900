...
(function($){
	...
	window.wxc.xcConfirm = function(popHtml, type, options) {
		...
		var $input = $("<input>").addClass("form-control");//输入框
		var $select = $("<select>").addClass("form-control");//输入框
		...
		function init(){
			...
			if(popType["input"] === itype){
				$txt.append($input);
				var html="<select class='form-control' id='rating'><option value=''>Rating</option><option value='1'>1</option><option value='2'>2</option><option value='3'>3</option><option value='4'>4</option><option value='5'>5</option></select>";
				//$select.append(html);
				$txt.append(html);
			}
